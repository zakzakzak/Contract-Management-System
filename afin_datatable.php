    ...
    <div class="az-header">
      <div class="container">
        <div class="az-header-left">
          <a href="" class="az-logo">TEKMIRA</a>
          <a href="" id="azMenuShow" class="az-header-menu-icon d-lg-none"><span></span></a>
          <h6><span></span>&nbsp | &nbsp AFIN</h6>
        </div><!-- az-header-left -->
        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/afin_index?id=31"><i class="typcn typcn-chart-area-outline"></i>Kontrak</a>
            </li>
            <!-- <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/afin_inbox"><i class="typcn typcn-chart-area-outline"></i> INBOX </a>
            </li> -->
          </ul>
        ...
        <div class="az-header-right">
          <div class="az-header-message">
            <a href="<?php echo base_url(); ?>home/afin_inbox"><i class="typcn typcn-messages"></i></a>
    ...
    <div class="az-content pd-y-20 pd-lg-y-30 pd-xl-y-40">
      <div class="container">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
          <h2 class="az-content-title">DataTable</h2>
