            ...
            <tbody>
              <?php for ($i=0; $i < count($hasil_pengajuan); $i++) :?>
                  <tr>
                    ...
                    <?php if ($hasil_pengajuan[$i]["status_realisasi"] == 0 || $hasil_pengajuan[$i]["status_realisasi"] == 1) :?>
                    <td><a href="<?php $pengajuan = $hasil_pengajuan[$i]["id_pengajuan"] ;echo base_url()."home/ppk_approve?id=$pengajuan" ;?>" class="btn btn-info btn-with-icon btn-block rounded-5">Approve</a></td>
                    <td><a href="<?php $pengajuan = $hasil_pengajuan[$i]["id_pengajuan"] ;echo base_url()."home/ppk_tolak?id=$pengajuan" ;?>" class="btn btn-danger btn-with-icon btn-block rounded-5">Tolak</a></td>
                  ...
                  <?php elseif ($hasil_pengajuan[$i]["status_realisasi"] == 3) :?>
