      ...
      <div class="media media-dashboard">
        <div class="media-body">
          <div class="az-content-header">
            <div>
              <h6 class="az-content-title tx-18 mg-b-5">Dashboard PIC</h6>
            ...
            <div class="card-body">
              <div class="table-responsive">
                  <table class="table table-striped table-dashboard-two mg-b-0">
                    <thead>
                      <tr>
                        <th class="wd-lg-85p">Judul Kontrak</th>
                        <th><center>Tanggal Pelaksanaan</center></th>
                        <th class="wd-lg-25p"><center>Progress</center></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="tx-medium tx-inverse"><center><?= $hasil_kontrak[$i]["tgl_mulai"]." s/d ".$hasil_kontrak[$i]["tgl_akir"] ?></center></td>
                        <td class=" tx-medium tx-danger">
                          <center><a href="<?= base_url()."home/program_detail_kontrak?id=".$hasil_kontrak[$i]["id_kontrak"];?>" class="badge badge-danger">2/9</a></center>
                        </td>
                      </tr>
                      <?php endfor; ?>
