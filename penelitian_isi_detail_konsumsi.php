...
if(isset($_POST["submit"])){
  // var_dump("ok");
  if (tambah_konsumsi($_POST, $id_pengajuan) > 0){
    echo ("
        <script>
          alert('data berhasil ditambahkan');
          document.location.href = '$baseurl/penelitian_view_form_konsumsi?id=$id_pengajuan';
        </script>
    ");
  }else{
    echo "
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
              <div class="card card-body pd-40">
                ...
                <div class="form-group">
                  <label class="az-content-label tx-11 tx-medium tx-gray-600">Uraian</label>
