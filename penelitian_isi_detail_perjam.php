...
if(isset($_POST["submit"])){
  // var_dump("ok");
  if (tambah_pekerja_perjam($_POST, $id_pengajuan) > 0){
    echo ("
        <script>
          alert('data berhasil ditambahkan');
          document.location.href = '$baseurl/penelitian_view_form_perjam?id=$id_pengajuan';
        </script>
    ");
  }else{
    echo "
        ...
        <div class="media-body">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
              <div class="card card-body pd-40">
                ...
                <div class="form-group">
                  <label class="az-content-label tx-11 tx-medium tx-gray-600">Materi</label>
                  <input type="text" class="form-control" name = "materi" required>
                </div>

                <div class="form-group">
                  <label class="az-content-label tx-11 tx-medium tx-gray-600">Jumlah Jam</label>
