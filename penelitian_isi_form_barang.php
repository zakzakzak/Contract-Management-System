...
if(isset($_POST["submit"])){
  // var_dump("ok");
  if (buat_form_barang($_POST, $id_pengajuan) > 0){
    echo ("
        <script>
          alert('data berhasil ditambahkan');
          document.location.href = '$baseurl/penelitian_view_form_barang?id=$id_pengajuan';
        </script>
    ");
  }else{
    echo "
        ...
        <div class="media-body">
            ...
            <div class="col-md-12 col-lg-12 col-xl-12">
              <div class="card card-body pd-40">
                <h5 class="card-title mg-b-20">Pengisian Data Form</h5>
