    ...
    <div class="az-header">
      <div class="container">
        <div class="az-header-left">
          ...
          <a href=""><i class="typcn "></i>&nbsp | &nbsp  PEJABAT TEKNIS </a>
        </div><!-- az-header-left -->
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item">
                <a href="<?php echo base_url(); ?>home/penelitian_index"><i class="fa fa-home"></i> Dashboard</a>
              </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/penelitian_inbox"><i class="far fa-envelope"></i> INBOX (<?php echo $inbox->jumlah;?>)</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/penelitian_pengajuan_tu"><i class="far fa-envelope"></i> PENGAJUAN</a>
            </li>
