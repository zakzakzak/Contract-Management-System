...
$hasil_pengajuan = query("SELECT id_pengajuan,jumlah,status_pengajuan,tgl_pengajuan,pengajuan2.keterangan FROM pengajuan2 ORDER BY id_pengajuan DESC");
            ...
            <tbody>
              <?php for ($i=0; $i < count($hasil_pengajuan); $i++) :?>
                  <tr>
                    ...
                    <?php if ($hasil_pengajuan[$i]["status_pengajuan"] == 0) :?>
                    <td><a href="<?php $pengajuan = $hasil_pengajuan[$i]["id_pengajuan"] ;echo base_url()."home/tata_usaha_approve_pengajuan?id=$pengajuan" ;?>" class="btn btn-info btn-with-icon btn-block rounded-5">Approve</a></td>
                    <td><a href="<?php $pengajuan = $hasil_pengajuan[$i]["id_pengajuan"] ;echo base_url()."home/tata_usaha_tolak_pengajuan?id=$pengajuan" ;?>" class="btn btn-danger btn-with-icon btn-block rounded-5">Tolak</a></td>
