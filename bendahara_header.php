    ...
    <div class="az-header">
      <div class="container">
        <div class="az-header-left">
          ...
          <a href=""><i class="typcn "></i>&nbsp | &nbsp  BENDAHARA </a>
        </div><!-- az-header-left -->
        <div class="az-header-menu">
          ...
          <ul class="nav">
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/bendahara_index"><i class="fas fa-home"></i> Dashboard</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/bendahara_list_po"><i class="fas fa-file-contract"></i> PO</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/bendahara_rekap_po"><i class="fas fa-print"></i> REKAP</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>home/bendahara_list_ba_po"><i class="fas fa-print"></i> BERITA ACARA</a>
            </li>
          </ul>
